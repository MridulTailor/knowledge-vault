...
(function () {
  ...
  function showHighlightPopup() {
    ...
    const saveSvg = document.createElementNS(
    ...
    const notePath1 = document.createElementNS(
      "http://www.w3.org/2000/svg",
      "path"
    );
    notePath1.setAttribute(
      "d",
      "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"
    );
    const notePolyline = document.createElementNS(
      "http://www.w3.org/2000/svg",
      "polyline"
    );
    notePolyline.setAttribute("points", "14,2 14,8 20,8");
    const noteLine1 = document.createElementNS(
      "http://www.w3.org/2000/svg",
      "line"
    );
    ...
    const noteLine2 = document.createElementNS(
      "http://www.w3.org/2000/svg",
      "line"
    );
